...
from .base import AuthorsBaseTest, By
...
class AuthorsLoginTest(AuthorsBaseTest):
    def test_user_valid_data_can_login_successfully(self):
        ...
        self.browser.get(self.live_server_url + '/authors/login/') # reverse('authors:login')
    ...
    def test_form_login_is_invalid(self):
        ...
        self.assertIn('Invalid username or password', self.browser.find_element(By.TAG_NAME, 'body'))
